...
public class ParserTest {
    ...
    void testE2EParsing() throws Exception {
        ExcelParser parser = new ExcelParser(newLayout());
        // FIX: hcer que se haga referencia a los archivos del classpath
        Path excelPath = Path.of(
